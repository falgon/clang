...
//@@
  void VisitExecuteStmt(const ExecuteStmt *E);
//@@
...
//@@
void EnqueueVisitor::VisitExecuteStmt(const ExecuteStmt *E) {
  AddStmt(E->getStmt());
}
//@@
...
//@@
  case CXCursor_QuasiQuoteExpr:
	  return cxstring::createRef("QuasiQuoteExpr");
//@@
...
//@@
  case CXCursor_ExecuteStmt:
	  return cxstring::createRef("ExecuteStmt");
//@@
  }
...
//@@
  ...
  case Decl::Execute:
  case Decl::Def:
  case Decl::PreprocessorDirective:
