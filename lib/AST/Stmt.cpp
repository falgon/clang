...
//@@
ExecuteStmt::ExecuteStmt(const ASTContext &C, Stmt *S, SourceLocation SL,
							SourceLocation EL)
	: Stmt(ExecuteStmtClass), stmt(S), StartLoc(SL), EndLoc(EL) {}

SourceRange ExecuteStmt::getInnerSourceRange() const {
