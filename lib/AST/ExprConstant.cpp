...
//@@ Renamed from StmtResult to avoid a name conflict with Sema::StmtResult
struct StmtResultInfo {
...
static EvalStmtResult EvaluateStmt(StmtResultInfo &Result, EvalInfo &Info,
                                   const Stmt *S,
                                   const SwitchCase *SC = nullptr);

/// Evaluate the body of a loop, and translate the result as appropriate.
static EvalStmtResult EvaluateLoopBody(StmtResultInfo &Result, EvalInfo &Info,
                                       const Stmt *Body,
...
static EvalStmtResult EvaluateSwitch(StmtResultInfo &Result, EvalInfo &Info,
                                     const SwitchStmt *SS) {
  BlockScopeRAII Scope(Info);
...
//@@
  case Stmt::ExecuteStmtClass:
    return ESR_Failed;	//no const evauation for other stages
//@@
...
static bool HandleFunctionCall(SourceLocation CallLoc,
  ...
  StmtResultInfo Ret = {Result, ResultSlot};
...
static bool HandleConstructorCall(SourceLocation CallLoc, const LValue &This,
  ...
  // wasteful.
  APValue RetVal;
  StmtResultInfo Ret = {RetVal, nullptr};
...
public:
  ...
  bool VisitStmtExpr(const StmtExpr *E) {
    ...
    for (CompoundStmt::const_body_iterator BI = CS->body_begin(),
      ...
      APValue ReturnValue;
      StmtResultInfo Result = { ReturnValue, nullptr };
