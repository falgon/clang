...
void Sema::LookupTemplateName(LookupResult &Found,
  ...
  if (LookupCtx) {
	...
	//@@
	//@@@
	//if (Found.getResultKind() == LookupResult::NotFoundInCurrentInstantiation)
	//	isDependent = true;
	//@@
...
Sema::CheckDependentFunctionTemplateSpecialization(FunctionDecl *FD,
  ...
  if (Previous.empty() /*@@*/ && !CurContext->allowUnresolvedIds() /*@@*/) return true;
...
Sema::ActOnTypenameType(Scope *S,
  ...
  if (DependentTemplateName *DTN = Template.getAsDependentTemplateName()) {
    ...
    assert(/*@@*/!DTN->getQualifier() || /*@@*/ DTN->getQualifier() == SS.getScopeRep());
...
Sema::CheckTypenameType(ElaboratedTypeKeyword Keyword, 
  ...
  if (!Ctx) {
    ...
    assert(/*@@*/ CurContext->allowUnresolvedIds() || /*@@*/
