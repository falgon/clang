...
/// \brief Matches execute statements.
///
/// Given
/// \code
///   .&;
...
/// executeStmt()
///   matches '.&;'.
const internal::VariadicDynCastAllOfMatcher<Stmt, ExecuteStmt> executeStmt;
...
//@@
/// \brief Matches quasi quote expressions.
///
/// Example matches .<1>.
/// \code
///   f(.<1>., 2)
