...
public:
  ...
  //@@
  /// \brief To support types generated by meta code, forge a DependentNameType
  /// and resolve it after the type is generated.
  ParsedType ActOnUnknownType(const IdentifierInfo &II, SourceLocation NameLoc);
  //@@
...
//@@
  QuasiQuotesDecl *getCurQuasiQuotesDecl();
//@@
...
//@@
  Decl* ActOnMetaGeneratedDecl(SourceLocation StartLoc, SourceLocation EndLoc,
								tok::TokenKind Kind, Expr *E);

  StmtResult ActOnExecuteStmt(SourceLocation StartLoc, SourceLocation EndLoc,
								Stmt *S);
  ExecuteDecl* ActOnStartExecuteDecl(SourceLocation ExecuteLoc);
  ExecuteDecl* ActOnEndExecuteDecl(ExecuteDecl *D, Stmt *S, SourceLocation EL);

  DefDecl* ActOnStartDefDecl(SourceLocation DefLoc);
  DefDecl* ActOnEndDefDecl(DefDecl *D, SourceLocation EndLoc);

  PreprocessorDirectiveDecl* ActOnPreprocessorDirectiveDecl(StringRef D,
...
//@@
  ...
  //@@
  void ActOnStartInlineExpr();

  QuotedElements *ActOnStartQuasiQuoteExpr(SourceLocation StartLoc);
  ExprResult ActOnEndQuasiQuoteExpr(SourceLocation StartLoc,
									SourceLocation EndLoc, QuotedElements *E);
  void ActOnQuasiQuoteExprError(void);
  //@@
...
public:
  ...
  // C++ Classes
  //
  //@@was: (the first arg) const IdentifierInfo &II
